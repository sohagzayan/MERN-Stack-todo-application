...
exports.sendConfirmationEmail = function({toUser, hash}) {
  const message = {
    ...
    html: `
      <h3> Hello  <h2>${toUser.name} ${toUser.lastName}</h2> user name </h3>
      <p>Thank you for registering into our Application. Much Appreciated! Just one last step is laying ahead of you...</p>
      <p>To activate your account please follow this link: <h1><a target="_" href="${process.env.DOMAIN}/api/activate/user/${hash}">${process.env.DOMAIN}/activate </a></h1> </p>
      <p>Cheers</p>
